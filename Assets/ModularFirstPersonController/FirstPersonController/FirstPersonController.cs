...
public class FirstPersonController : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        Game_Manager.OnPlayerCaughtBy_Enemy += HandlePlayerCought;
        Game_Manager.OnGameWon += HandlePlayerCought;
    }
    ...
    private void Update()
    {
        ...
        if (cameraCanMove)
        {
            yaw = transform.localEulerAngles.y + game_Manager.look.x * mouseSensitivity;

            if (!invertCamera)
            {
                pitch -= mouseSensitivity * game_Manager.look.y;
            }
            else
            {
                // Inverted Y
    ...
    void FixedUpdate()
    {
        ...
        if (playerCanMove)
        {
            ...
            Vector3 targetVelocity = new Vector3(game_Manager.move.x, 0, game_Manager.move.y).normalized;
    ...
    private void HandlePlayerCought()
    {
        rb.isKinematic = true;
        _isDead = true;
    }
...
public class FirstPersonControllerEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.Space();
        fpc._soundRun = (AudioSource)EditorGUILayout.ObjectField(fpc._soundRun, typeof(AudioSource), true);
